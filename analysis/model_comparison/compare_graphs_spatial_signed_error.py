...
def main():
    ...
    comparison_outputs_dir = os.path.join(project_root, "outputs", "analysis", "model_comparison")
    ...
    output_path = os.path.join(comparison_outputs_dir, "combined_spatial_signed_error.png")
