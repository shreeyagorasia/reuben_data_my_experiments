...
Usage from repo root:
    ...
    python outputs/compare_results/compare_plot_subtract.py

Optional:

    python outputs/compare_results/compare_plot_subtract.py --vmax 0.25
"""
...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "compare_results"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Symmetric color limit for error difference. Default uses robust 95th percentile.",
    )
